...
namespace Hawk.SharpZipLib.Checksum
{
	/// <summary>
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="Hawk.SharpZipLib.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="Hawk.SharpZipLib.Zip.Compression.Streams.DeflaterOutputStream"/>
