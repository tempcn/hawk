...
using Hawk.SharpZipLib.Encryption;
using Hawk.SharpZipLib.Core;
using Hawk.SharpZipLib.Checksum;
using Hawk.SharpZipLib.Zip.Compression.Streams;
using Hawk.SharpZipLib.Zip.Compression;
using System.Collections.Generic;

namespace Hawk.SharpZipLib.Zip
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Hawk.SharpZipLib.Zip.ZipException">
