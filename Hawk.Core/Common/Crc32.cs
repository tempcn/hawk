...
namespace Hawk.Common
{
    ...
    internal class Crc32 : HashAlgorithm
    {
        ...
        //           System.IO.FileStream fp1;
        //            byte ch;
        //            string file_name = @"d:\software\system\android-x86-4.0-RC2-asus_laptop.iso";
        //            fp1 = new System.IO.FileStream(file_name, System.IO.FileMode.Open);
        //            long len = fp1.Length;
        ...
        //            //Console.WriteLine("CRC32: " + System.Convert.ToString(crc, 16));
...
//            for (int i = 0; i < 4; i++)
//            {
//                buffer2[(num3 * 4) + i] = (byte)(this.context[num3] >> (8 * i));
//            }
//        }
//        this.engineReset();
//        return buffer2;
...
//        }
//        int destinationIndex = (int)(this.count % 0x40);
//        this.count += len;
