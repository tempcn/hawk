...
namespace System
{
    public static class Regular
    {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsBase64(this string s) => IsRegular(s, "^[a-zA-Z0-9+/]+[=]{0,2}$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsEmail(this string s) => IsRegular(s, @"^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsMobile(this string s) => IsRegular(s, @"^0?(13|14|15|17|18)\d{9}$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsAlphanumeric(this string s) => IsRegular(s, "^\\w+$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsSimplifiedChinese(this string s) => IsRegular(s, @"^[\u4e00-\u9fa5]+$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsNatural(this string s) => IsRegular(s, @"^(0|([1-9]\d*)){1}$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsDec(this string s) => IsRegular(s, @"^(0|([1-9]\d*))(\.\d+)?$");
        //{
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsInteger(this string s) => IsRegular(s, @"^(-)?(0|([1-9]\d*))$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsIpv4(this string s) => IsRegular(s, @"^((25[0-5]|2[0-4]\d|[01]?\d\d?)\.){3}(25[0-5]|2[0-4]\d|[01]?\d\d?)$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsTel(this string s) => IsRegular(s, @"^0(\d{2}[-]?\d{8}|\d{3}[-]?(\d{7}|\d{8}))$");

        /// <summary>
        /// 判断字符串是否符合十六进数制格式
        /// </summary>
        /// <returns></returns>
        public static bool IsHex(this string s) => IsRegular(s, "^[a-fA-F0-9]+$");

        /// <summary>
        /// 检测相对于Sql语句是否安全(不包含null和空)
        /// </summary>
        /// <param name="pattern">Sql语句不能包含的字符</param>
        /// <returns></returns>
        public static bool IsSafeSql(this string s, string pattern = @"[-|%|@|\*|!|\']")
            => string.IsNullOrEmpty(s) ? false : !Regex.IsMatch(s, pattern, RegexOptions.None);
        ...
        public static bool IsIdentityCard(this string s, out string num)
        {
            bool flag = false;
            num = "";
            if (s.IsNotNullOrEmpty() && Regex.IsMatch(s, @"(^\d{ 15}$)| (^\d{ 17} ([0 - 9] |[X | x])$)"))
            {
