...
namespace System
{
    ...
    public static class EnumHelper
    {
        ...
        public static string ToStringEx(this Enum value) => Enum.GetName(value.GetType(), value);


        public static string[] ToStringsEx(this Enum value) => Enum.GetNames(value.GetType());
    }
}
